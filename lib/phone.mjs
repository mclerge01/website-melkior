...
/**
 * Parse a contact-form phone number using libphonenumber metadata.
 *
 * @param {string} value - User-entered phone number.
 * @returns {import("libphonenumber-js").PhoneNumber|null} Valid parsed phone number, or null.
 */
...
/**
 * Format a contact-form phone number according to how it was entered.
 *
 * @param {string} value - User-entered phone number.
 * @returns {string} National formatting for local NANP values, otherwise international formatting.
 */
