...
export function parseContactPhoneNumber(value) {
  ...
  return parseNationalNumber(normalized);
}
...
export function isValidContactPhoneNumber(value) {
  return Boolean(getValidContactPhoneNumber(value));
}
